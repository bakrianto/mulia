<div class="no-faktur">
  ...
  <div class="form-inline">
    <div class="form-group">
      <label for="exampleInputName2">Kode Transaski </label>
        ...
        <?php
          ...
          while ($mm=mysqli_fetch_array($menu_makan)) {
              ...
              <label style=\"width:200px\"> 
                  <input type=\"checkbox\" name=\"menu[]\" value=\"$mm[id_menu]\" class=\"$menu_ma\">$no.&nbsp;$mm[nama_menu]
              </label>&nbsp;
      ...
      <div class="panel-body">
        <?php
            ...
            while ($mi_m=mysqli_fetch_array($menu_minum)) {
                ...
                echo "<div class=\"checkbox\">
                <label style=\"width:200px\"> 
                    <input type=\"checkbox\" name=\"menu[]\" class=\"$menu_mi\" value=\"$mi_m[id_menu]\">$no.&nbsp;$mi_m[nama_menu]
                </label>&nbsp;
