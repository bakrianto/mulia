    ...
    <div id="navbar" class="navbar-collapse collapse center">
        <div class="container">
            <ul class="nav navbar-nav">
                ...
                ?>
                <li>
                <a href="?pg=setting&act=setting&id_setting=<?=$data["id_setting"]?>"><i class="glyphicon glyphicon-home"></i> Beranda</a>
                </li>
                <?php } ?>
                <!-- <li>
                <a href="index.php?pg=setting"><i class="fa fa-home fa-fw"></i> Home</a>
                </li> -->
                <li>
...
<section style="background-color: #ffffff">
    <?php
    if(empty($_GET['pg']) OR $_GET['pg']=='setting')include 'setting.php';
